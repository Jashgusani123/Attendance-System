...
import {
  AdminCreatetationRequest,
  AdminCreatetationResponse,
  AdminLoginRequest,
  AdminLoginResponse,
  AdminLogoutRespose,
  AdminRequest,
  ...
  Departments,
  FirstCard,
  JoingTableDataResponse,
  LoginFingerprintVerificationRequest,
  LoginFingerprintVerificationRespose,
  ...
  ResponseForCollege,
  ResponseOfAllCollege,
  ResponseOfNotification,
  SearchWordResponse,
  UsersResponse,
} from "../../Types/API/AdminType";
...
export const AdminAPI = createApi({
  ...
  endpoints: (builders) => ({
    ...
    notification: builders.mutation<
      ResponseOfNotification,
      RequestNotification
    >({
    ...
    RegisterPasskey: builders.mutation<
      RegisterCredentialResponse,
      RegisterCredentialRequest
    >({
      query: ({ Id }) => ({
    ...
    loginCredential: builders.mutation<
      RegisterCredentialResponse,
      RegisterCredentialRequest
    >({
      query: ({ Id }) => ({
    ...
    verifyPasskey: builders.mutation<
      { success: true },
      { Id: string; cred: any }
    >({
      query: ({ Id, cred }) => ({
...
export const {
  ...
  useVerifyPasskeyMutation,
  useCreatecollegeMutation,
  useGetAllCollegesQuery,
  useGetCollegeQuery,
  useSearchCollegeQuery,
  useGetAllDepartmentsQuery,
  useGetAllClassesQuery,
  useGetFirstCardsQuery,
  useGetJoingTableQuery,
  useGetAllUsersQuery,
  useGetRequestsQuery,
